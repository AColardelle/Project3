...
<!--Affichage des likes -->
<div class="likes"><a href="likes.php?t=1&id=<?=$id ?> "> <img class="pouce" src="img/pouce_bleu.png" alt="pouce"><?php echo "".$likes.""; ?></a></div><?php
session_start();
include("connexion_db.php");
...
<div class="new_com"> <a href="article.php?id_acteur=<?php echo $donnees['id_acteur'] ?>&new_post=1"><input type="hidden" value="Nouveau commentaire" />Nouveau Commentaire</a></div>
