    ...
    if (!empty($_POST['pseudo']))
    {
        ...
        else
        {
          if ($isPasswordCorrect)
          {
            ...
            <p>
              <form action="update_pass.php" method="POST">
                ...
                <input type="password" name="changement_pass" id="changement_pass" value required /></br>
          ...
          else
          {
             ...
             <form id="message" action="" method="POST">
               ...
               <input type="pseudo" name="pseudo" id="pseudo"  value required>
      ...
      else
      {
          ...
          if ($count == 1)
          {
              ...
              echo "la question est :'" . $test['question'] . "'"; ?>
              <form id="message" action="" method="POST">
                <label for="pass_question"></label><br />
                <input type="pass_question" name="pass_question" id="pass_question" value required>
                <input type="hidden" name="pseudo" id="pseudo" value="<?php echo $_POST['pseudo'] ?>">
                <input type="submit" value="envoyer la reponse " class="bouton" >
              </form><?php
          }
          else
          {
