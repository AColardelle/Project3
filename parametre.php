...
<p>
  ...
  <input type="submit" value="Changer votre pseudo" /> </form>
</p>
  <?php
...
<h3>Chnager de mot de passe</h3>
<p>
  <form action="" method="POST">
  <label for="pass"></label><br>
  <input type="password" name="pass" id="pass" /></br></br>
  <input type="submit" value="Changer votre mot de passe" /></form>
  <?php
    if (isset($_POST['pass'])) {
...
<p>
  ...
  <input type="submit" value="Changer votre nom" /></form><br/>
  <?php
    if (isset($_POST['nom'])) {
...
<p>
  ...
  <input type="submit" value="Changer votre prenom" /><br/></form></br>
  <?php
...
<p>
  ...
  <input type="submit" value="Changer question & reponse" /><br/></form><br/>
  <?php
